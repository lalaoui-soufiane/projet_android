...
import fr.ccm.m1.android.projet.databinding.ActivityRamenerAvatarBinding;

public class RamenerAvatarActivity extends AppCompatActivity {
    private String uid, email = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ramener_avatar);
        ...
        ActivityRamenerAvatarBinding binding = DataBindingUtil.setContentView(this, R.layout.activity_ramener_avatar);
    ...
    public void goToMenu() {
        Intent menuActivity = new Intent(RamenerAvatarActivity.this, MenuActivity.class);
    ...
    public void goToLogin() {
        ...
        Intent loginActivity = new Intent(RamenerAvatarActivity.this, LoginActivity.class);
